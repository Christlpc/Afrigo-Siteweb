...
export function DownloadSection() {
    return (
        <section className="section-bolt section-bolt-green relative overflow-hidden">
            {/* Pattern */}
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 items-start">
                            ...
                            <div className="bg-white p-4 rounded-2xl">
                                <div className="w-32 h-32 bg-bolt-dark rounded-lg flex items-center justify-center">
                                    <span className="text-white text-xs text-center px-2">QR Code<br />Bientôt</span>
                                </div>
                                <p className="text-bolt-dark text-sm font-medium mt-2 text-center">
                            ...
                            <div className="flex flex-col gap-3">
                                <button className="bg-bolt-dark hover:bg-gray-800 text-white rounded-xl px-6 py-4 flex items-center gap-4 transition-colors">
